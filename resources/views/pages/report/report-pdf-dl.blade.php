    ...
    <div class="report-container">
        ...
        @if($acDatas->count() > 0)
            <table cellpadding="0" cellspacing="0" style="border-collapse: collapse;"">
                <thead>
                    <tr>
                        <th colspan="2" style="text-align: center">DOKUMENTASI</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    @foreach($acDatas as $acData)
                        <tr>
                            <td style="width: 450px"><img style="max-width: 450px" src="{{public_path($acData->imageUrl)}}" alt="{{$acData->imageDesc}}"></td>
                            <td>
